        ...
        .then(user => {
                ...
                user.forEach(u => {
                    body += `
                     ...
                     <td>${u.email}</td>
                     <td>${rol(u)}</td>
                     <td><a class="btn btn-primary" data-btn="editUser" data-id="${u.id}">Edit</a></td>
                     <td><a class="btn btn-danger" data-btn="deleteUser" data-id="${u.id}">Delete</a></td>
                     </tr>
                `
                })
            ...
            <div class="update-body">
                <div class="update-content">
                    <div class="form-group">
                        ...
                        <input class="form-control" type="text"  id="firstName" placeholder="${oneUserfromDB.username}">
                        <label for="age">Age</label>
                        <input class="form-control" type="number" id="age" placeholder="${oneUserfromDB.age}">
                        <label for="email">Email</label>
                        <input class="form-control" type="text" id="email" placeholder="${oneUserfromDB.email}">
